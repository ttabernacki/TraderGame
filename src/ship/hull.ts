...
export const HULL_CLASSES: HullClass[] = [
  {
    ...
    masts: [lateen('Mastro', 90, 8.5, 0.05)],
  ...
  },
  {
    ...
    masts: [
      lateen('Mastro grande', 150, 12.5, 0.1),
      lateen('Mezena', 78, 9.5, -0.55),
    ],
  ...
  },
  {
    ...
    masts: [
      square('Traquete', 105, 11.0, 0.62),
      lateen('Mastro grande', 150, 13.0, 0.02),
      lateen('Mezena', 70, 9.5, -0.62),
    ],
  ...
  },
  {
    ...
    masts: [
      square('Traquete', 175, 13.0, 0.66),
      square('Mastro grande', 300, 17.5, 0.03),
      lateen('Mezena', 95, 11.0, -0.66),
    ],
  ...
  },
  {
    ...
    masts: [
      square('Traquete', 250, 15.5, 0.66),
      square('Mastro grande', 430, 21.0, 0.03),
      lateen('Mezena', 130, 12.5, -0.64),
    ],
  ...
  },
  {
    ...
    masts: [
      square('Traquete', 340, 17.5, 0.66),
      square('Mastro grande', 620, 24.5, 0.03),
      square('Gávea do grande', 180, 33.0, 0.03),
      lateen('Mezena', 180, 14.0, -0.64),
    ],
